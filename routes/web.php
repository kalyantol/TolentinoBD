...
Route::get('/student/list', [App\Http\Controllers\StudentController::class, 'index'])->name('student.list')->middleware('verified');
Route::get('/add/student', [App\Http\Controllers\StudentController::class, 'addstudent'])->name('add.student')->middleware('verified');
Route::post('/add/student/page', [App\Http\Controllers\StudentController::class, 'addstudentstore'])->name('add.student.store')->middleware('verified');
